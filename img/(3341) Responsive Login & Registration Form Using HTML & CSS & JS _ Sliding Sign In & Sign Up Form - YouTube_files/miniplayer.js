...
fill:"#fff","fill-rule":"nonzero"}}]}]}]};var e="Abrir p\u00e1gina do v\u00eddeo";a.O().ha("kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d=g.W?{D:"div",Y:["ytp-icon","ytp-icon-expand-miniplayer"]}:{D:"svg",P:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},K:[{D:"g",P:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},K:[{D:"g",P:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},K:[{D:"path",P:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expandir");g.U.call(this,{D:"button",Y:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],P:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.H=a;this.na("click",this.onClick,this);this.ma("title",g.yO(a,e,"i"));g.Ne(this,g.kP(b.wb(),this.element))},P5=function(a){g.U.call(this,{D:"div",
J:"ytp-miniplayer-ui"});this.jl=!1;this.player=a;this.L(a,"minimized",this.Ih);this.L(a,"onStateChange",this.gP)},Q5=function(a){g.RN.call(this,a);
...
g.k.show=function(){this.Gc=new g.zn(this.Nn,null,this);this.Gc.start();if(!this.jl){this.tooltip=new g.wS(this.player,this);g.C(this,this.tooltip);g.DN(this.player,this.tooltip.element,4);this.tooltip.Ud=.6;this.tb=new g.dP(this.player);g.C(this,this.tb);this.Xi=new g.U({D:"div",J:"ytp-miniplayer-scrim"});g.C(this,this.Xi);this.Xi.ca(this.element);this.L(this.Xi.element,"click",this.JC);var a=new g.U({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Fechar"},K:[g.zM()]});
g.C(this,a);a.ca(this.Xi.element);this.L(a.element,"click",this.Fl);a=new O5(this.player,this);g.C(this,a);a.ca(this.Xi.element);this.qj=new g.U({D:"div",J:"ytp-miniplayer-controls"});g.C(this,this.qj);this.qj.ca(this.Xi.element);this.L(this.qj.element,"click",this.JC);var b=new g.U({D:"div",J:"ytp-miniplayer-button-container"});g.C(this,b);b.ca(this.qj.element);a=new g.U({D:"div",J:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ca(this.qj.element);var c=new g.U({D:"div",J:"ytp-miniplayer-button-container"});
g.C(this,c);c.ca(this.qj.element);this.fD=new g.XQ(this.player,this,!1);g.C(this,this.fD);this.fD.ca(b.element);b=new g.TQ(this.player,this);g.C(this,b);b.ca(a.element);this.nextButton=new g.XQ(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.ca(c.element);this.fg=new g.gS(this.player,this);g.C(this,this.fg);this.fg.ca(this.Xi.element);this.jc=new g.fR(this.player,this);g.C(this,this.jc);g.DN(this.player,this.jc.element,4);this.Kq=new g.U({D:"div",J:"ytp-miniplayer-buttons"});g.C(this,
this.Kq);g.DN(this.player,this.Kq.element,4);a=new g.U({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Fechar"},K:[g.zM()]});g.C(this,a);a.ca(this.Kq.element);this.L(a.element,"click",this.Fl);a=new g.U({D:"button",Y:["ytp-miniplayer-replay-button","ytp-button"],P:{"aria-label":"Fechar"},K:[g.NM()]});g.C(this,a);a.ca(this.Kq.element);this.L(a.element,"click",this.iN);this.L(this.player,"presentingplayerstatechange",this.Ub);this.L(this.player,"appresize",this.Pa);this.L(this.player,
...
g.k.iN=function(){this.player.playVideo()};
g.k.JC=function(a){if(a.target===this.Xi.element||a.target===this.qj.element)g.P(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.nH(g.qM(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ra("onExpandMiniplayer")};
...
g.k.Nn=function(){this.Xc();this.Gc&&this.Gc.start()};
g.k.Ub=function(a){g.T(a.state,32)&&this.tooltip.hide()};
g.k.Pa=function(){this.jc.setPosition(0,g.mN(this.player).getPlayerSize().width,!1);this.jc.jx()};
g.k.gP=function(a){this.player.app.I.o&&(0===a?this.hide():this.show())};
